...
function Map({shopsList}) {
  ...
  //   // Add markers to the map for each shop
  //   const markers = shopsList.map((shop) => {
  //     console.log(shop)
  //     const coords = {
  ...
  //   behaviorRef.current = behavior;  // Save the behavior object so it can be disposed of later
